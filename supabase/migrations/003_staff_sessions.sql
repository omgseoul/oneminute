-- Install staff session/report functions. Client execution stays DISABLED.
-- Activate only after rotating the PINs shown in chat and verifying the app.
begin;
...
select p.proname as function_name,
  not (has_function_privilege('anon', p.oid, 'EXECUTE')
    or has_function_privilege('authenticated', p.oid, 'EXECUTE')) as access_locked
